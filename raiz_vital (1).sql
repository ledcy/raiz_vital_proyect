...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-03-2026 a las 03:55:49
...
INSERT INTO `imagenes_proyecto` (`id_imagen`, `id_proyecto`, `nombre_archivo`, `tipo`, `orden`) VALUES
(1, 14, '1773086964876.png', 'portada', 0),
(2, 15, '1773101184620.png', 'portada', 0),
(3, 16, '1773108921527.png', 'portada', 0),
(4, 17, '1773109106145.png', 'portada', 0),
(5, 18, '1773111133703.png', 'portada', 0),
(6, 19, '1773111204104.png', 'portada', 0);
...
(14, 1, 'RDR', '2026-05-20', 'Salaverga que basado', 'Educación', 'Educación', 'Cuame la Bella', 200.0000, NULL),
(15, 1, 'Educacion', '2026-03-20', 'qwertyuiop', 'Educación', 'Educación', 'qwertyuiop', 15000.0000, NULL),
(16, 1, 'PruebaTryCatch', '2026-12-20', 'asdfghjkl', 'Bienestar', 'Educación', 'asdfghjkl', 1500.0000, NULL),
(17, 1, 'PruebaTry', '2026-02-20', 'zxcvbnm', 'Bienestar', 'Bienestar', 'zxcvbn', 6500.0000, NULL),
(18, 1, 'Salaverga', '2019-11-25', 'Hey', 'Bienestar', 'Bienestar', 'zxcvb', 2500.0000, NULL),
(19, 1, 'Requiem', '2026-02-20', 'qwertyuio', 'Bienestar', 'Bienestar', 'qwertyui', 6500.0000, NULL);
...
ALTER TABLE `imagenes_proyecto`
  ...
  ADD KEY `idfk_imagen_proyecto` (`id_proyecto`);
...
--
-- Filtros para la tabla `imagenes_proyecto`
--
ALTER TABLE `imagenes_proyecto`
  ADD CONSTRAINT `idfk_imagen_proyecto` FOREIGN KEY (`id_proyecto`) REFERENCES `proyecto` (`id_proyecto`) ON UPDATE CASCADE;
