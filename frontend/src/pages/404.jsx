    ...
    <div class="min-h-screen bg-[#fdfbf7] flex flex-col items-center justify-center relative overflow-hidden px-6">
      ...
      <div class="relative z-10 w-full max-w-4xl flex flex-col items-center">
        ...
        <div class="text-center max-w-xl">
          <p class="text-[#5c6d5e] text-xl md:text-2xl mb-12 leading-relaxed">
            Parece que este camino se ha cerrado. No te preocupes, siempre
            podemos volver a plantar una nueva ruta.
          </p>

          <div class="flex flex-col md:flex-row items-center justify-center gap-6">
            <a
              href="/"
              class="group relative px-12 py-4 bg-[#2d5a27] text-white font-bold rounded-full overflow-hidden transition-all hover:scale-105 shadow-xl shadow-green-900/20"
            >
            ...
            <a
              href="/causas"
              class="px-12 py-4 text-[#2d5a27] font-bold border-2 border-[#2d5a27] rounded-full hover:bg-[#2d5a27] hover:text-white transition-all"
            >
              Explorar Causas
            </a>
          </div>
      ...
      <div class="absolute bottom-10 left-0 right-0 flex justify-center opacity-30">
        <div class="flex items-center gap-4">
          ...
          <span class="text-xs font-bold uppercase tracking-[0.4em] text-[#2d5a27]">
            Raíces de Vida
          </span>
          <div class="h-[1px] w-20 bg-[#2d5a27]"></div>
        </div>
